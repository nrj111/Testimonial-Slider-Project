    ...
    <div className='flex flex-col md:relative'>
        <div className='absolute top-[-7rem] z-[10] mx-auto'  >
            <img className='aspect-square rounded-full w-[140px] h-[140px] z-25'
             alt='Image_Here' src={review.image}/>
        </div>

        <div className='w-[140px] h-[140px] bg-violet-500 rounded-full absolute top-[-120px] x[-10] left-[10px]'></div>

        <div className='className="text-center mt-7'>
